...
#echo -e "	[+]              $red Coded By Nitin-Linux $nc         		   [+]"
#echo -e "	[+] 		 $red Nitin-Linux.net $nc 		   [+]"
#echo -e "	[+] 		 $red Greetz To All Pentesters$nc          		   [+]"
#echo -e "	[+]$red Special Greetz To$nc :$green {thelinuxchoice , Nitin-Linux , Th3 mastermind  }$nc [+]"
echo ""
